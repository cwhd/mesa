...
class Cooperate(Model):
    ...
    def __init__(self, height=grid_h, width=grid_w, init_cows=10, stride_length=1, 
                cooperative_probabilty=1, metabolism=1, reproduction_cost=1, reproduction_threshold=1):
        '''
        ...
        for i in range(self.init_cows):
            ...
            energy = self.random.randrange(0, 10) #TODO should this be more thought out?
            is_greedy = False
            #is this a greedy cow or now?
